...
@section('hero-section')
  <!-- Hero Section Start -->
  @if ($heroSection)
    <section class="hero-section overlay pt-50 pb-50 lazy"
      data-bg="{{ asset('assets/admin/img/hero-section/' . $heroSection->background_image) }}">
    @else
      <section class="hero-section overlay pt-50 pb-50 lazy" data-bg="{{ asset('assets/front/images/hero-bg.jpg') }}">
  @endif
  <div class="container">
...
@section('content')
                      ...
                      @if ($event->organizer_id != null)
                        ...
                        @if ($organizer)
                          <a href="{{ route('frontend.organizer.details', [$organizer->id, str_replace(' ', '-', $organizer->username)]) }}"
                            class="organizer text-capitalize">{{ __('Hosted By: ') }}&nbsp;{{ $organizer->username }}</a>
                        @endif
                      @else
                        @php
                        ...
                        <a href="{{ route('frontend.organizer.details', [$admin->id, str_replace(' ', '-', $admin->username), 'admin' => 'true']) }}"
                          class="organizer text-capitalize">{{ $admin->username }}</a>
                      @endif
  ...
  @if ($secInfo->about_section_status == 1)
    <section class="about-section pb-120 rpb-95 d-none">
      <div class="container">
...
<!-- Client Logo Start -->
  @if ($secInfo->partner_section_status == 1)
    <section class="client-logo-area text-center pt-50 rpt-80 pb-90 rpb-70">
      <div class="container">
        <div class="section-title mb-55">
          <h2>{{ $partnerInfo ? $partnerInfo->title : __('Top Partners & Organisers') }}</h2>
  ...
  <section class="feature-section pt-110 rpt-90 bg-lighter">
    ...
    @if ($secInfo->how_work_section_status == 1)
      @if ($howWork)
        <div class="work-process text-center d-none">
          <div class="container">
  ...
  @if ($secInfo->testimonials_section_status == 1)
    <section class="testimonial-section pt-120 rpt-80 d-none">
      <div class="container">
