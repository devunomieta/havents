            ...
            <div class="row mt-35">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <p id="lnameError" class="text-danger" style="display: none;"></p> 
                    </div>
                </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <p id="phoneError" class="text-danger" style="display: none;"></p> 
                    </div>
                </div>
              <div class="col-sm-6">
                <div class="form-group">
...
<script>
    function validatePhone(input) {
        ...
        if (!regex.test(input.value)) {
            errorElement.textContent = "Phone number must contain only numbers.";
            errorElement.style.display = "block";
        } else {
            errorElement.style.display = "none";
        }
