          ...
          <div class="row">
            ...
            <div class="col-lg-4 mt-2 mt-lg-0">
              ...
              <a href="{{ route('organizer.withdraw.create', ['language' => $defaultLang->code]) }}"
                ...
                <i class="fas fa-minus"></i> {{ __('Withdraw Now')."!" }}
              </a>

              <button class="d-none btn btn-danger btn-sm float-lg-right float-left mr-2 d-none bulk-delete"
              ...
              <table class="table table-striped mt-3" id="basic-datatables">
                <thead>
                  <tr>
                    ...
                    <th scope="col">{{ __('Withdrawal Id') }}</th>
