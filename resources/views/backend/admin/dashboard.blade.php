            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Total Earnings') }}</p>
                    <h4 class="card-title">
          ...
          <div class="card card-stats card-earning card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats" style="color: #fff">
                  <div class="numbers">
                    <p class="card-category">{{ __('Total Profits') }}</p>
                    <h4 class="card-title">
                      {{ $settings->base_currency_symbol_position == 'left' ? $settings->base_currency_symbol : '' }}
          ...
          <div class="card card-stats card-success card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Total Events') }}</p>
          ...
          <div class="card card-stats card-secondary card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Total Transactions') }}</p>
          ...
          <div class="card card-stats card-warning card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Total Organizers') }}</p>
          ...
          <div class="card card-stats card-secondary card-round">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-7 col-stats">
                  <div class="numbers">
                    <p class="card-category">{{ __('Registered Attendees') }}</p>
